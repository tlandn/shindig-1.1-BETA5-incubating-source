...
public class ShindigIntegratorOAuthDataStore implements OAuthDataStore {
  ...
  @Inject
  public ShindigIntegratorOAuthDataStore(JsonDbOpensocialService dbService, @Named("shindig.oauth.base-url") String baseUrl) {
